...
export class FileManagementController {
  ...
  @Patch('file/:id')
  updateFileName(@Param('fileId') fileId: string, @Body() updateFileManagementDto: UpdateFileNameDto) {
    return this.commandBus.execute(updateFileManagementDto)
  }

  @Patch('folder/:folderId')
  updateFolderName(@Param('folderId') folderId: string, @Body() updateFileManagementDto: UpdateFileNameDto) {
    return this.commandBus.execute(updateFileManagementDto)
  }
